...
module Communificiency
  class Application < Rails::Application
    ...
    config.STRIPE_API_KEY_TEST = "sk_0D4ItJKUqqLPRZ3vS9A8Mgl6IiHMz" 
    config.STRIPE_API_KEY_TEST_PUBLIC = "pk_0D4IReQ9k27INskXO9QqIN8nh39bQ" 

    config.STRIPE_API_KEY_PROD = "sk_0D4IlAP7YQ4Q0uLT43PMe5JCJe9zl"
    config.STRIPE_API_KEY_PROD_PUBLIC = "pk_0D4ISXBTWRBQFdwygUwzrOXOc6xC4" 

    config.STRIPE_API_KEY =  config.STRIPE_API_KEY_TEST
    config.STRIPE_API_KEY_PUBLIC =  config.STRIPE_API_KEY_TEST_PUBLIC
